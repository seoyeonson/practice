package com.sy.sbkafka.global.initData;
...
import com.sy.sbkafka.domain.post.author.service.AuthorService;
...
public class InitData {
    ...
    public void work2() {
        ...
        Post post1 = postService.write(author1, "제목1", "내용1").getData();
        Post post2 = postService.write(author2, "제목1", "내용1").getData();
    ...
    public void work3() {
        ...
        Post post3 = postService.write(author3, "제목1", "내용1").getData();
    }

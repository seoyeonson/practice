...
public class OrderSeviceTest {
    ...
    @Autowired private OrderSevice orderSevice;
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        //when
        orderSevice.order(member.getId(), book.getId(), orderCount);
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상상품은 그만큼 재고가 증가해야 한다.", 10, book.getStockQuantity());
    }
